...
public class UserController {
    ...
    public UserController(UserService userService,
                          ...
                          MapperToDto<User, UserResponseDto> mapperToDto) {
    ...
    @PostMapping
    public ResponseEntity<Void> create(UserRequestDto requestDto) {
    ...
    @PutMapping("/{userId}")
    public void update(@PathVariable Long userId, UserRequestDto requestDto) {
        User user = mapToEntity.mapToEntity(requestDto);
        user.setId(userId);
